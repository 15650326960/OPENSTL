...
def CMDAF(vi_feature, ir_feature):
    ...
    conv1 = nn.Conv2d(in_channels=sub_vi_ir.shape[1], out_channels=sub_vi_ir.shape[1], kernel_size=3, padding=1).to(device)
    conv2 = nn.Conv2d(in_channels=sub_vi_ir.shape[1], out_channels=sub_vi_ir.shape[1], kernel_size=3, padding=1).to(device)
    conv3 = nn.Conv2d(in_channels=sub_vi_ir.shape[1], out_channels=sub_vi_ir.shape[1], kernel_size=3, padding=1).to(device)
    ...
    conv4 = nn.Conv2d(in_channels=sub_ir_vi.shape[1], out_channels=sub_ir_vi.shape[1], kernel_size=3, padding=1).to(device)
    conv5 = nn.Conv2d(in_channels=sub_ir_vi.shape[1], out_channels=sub_ir_vi.shape[1], kernel_size=3, padding=1).to(device)
    conv6 = nn.Conv2d(in_channels=sub_ir_vi.shape[1], out_channels=sub_ir_vi.shape[1], kernel_size=3, padding=1).to(device)
    ...
    vi_feature = vi_feature + ir_vi_div1
    ir_feature = ir_feature + vi_ir_div1
