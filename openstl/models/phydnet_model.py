...
class PhyDNet_Model(nn.Module):
    ...
    def __init__(self, configs, **kwargs):
        ...
        self.pre_seq_length = configs.pre_seq_length    # 10
        self.aft_seq_length = configs.aft_seq_length    # 10
        _, C, H, W = configs.in_shape   #   10, 1, 64, 64
        patch_size = configs.patch_size if configs.patch_size in [2, 4] else 4  # 4
        input_shape = (H // patch_size, W // patch_size)    # (16, 16)
        ...
        self.convcell = PhyD_ConvLSTM(input_shape=input_shape, input_dim=64, hidden_dims=[128,128,64],
                                    ...
                                    #(16, 16), 64, [128,128,64], 3, (3, 3), configs.device
